...
\definecolor{flower}{HTML}{484898}
\definecolor{stx}{HTML}{FF6E54}
\newcommand{\flower}[1]{\textcolor{flower}{#1}}
\newcommand{\stx}[1]{\textcolor{stx}{#1}}
...
% Hopefully fix the figure groupings in the LOF?
\usepackage{etoolbox}
...
\includepdf[pages=-]{../images/front-cover.pdf}
\includepdf[pages=-]{../images/front-cover-back.pdf}
...
A family of 18 molecules based on octathio[8]circulene was defined and modeled, including circulenes with different combinations of heteroatoms (S, Se, As, P and N), and different numbers of rings (8, 10 and 12).
In order to characterize them, several of their properties were studied and discussed: bond lengths, ring strain, nucleus-independent magnetic shielding (NICS), and Raman and electronic spectra.
Then, they were used as substrates to adsorb the marine toxin saxitoxin (STX).
This resulted in an enhancement of its electronic properties, which allowed us to study its electronic and Raman spectra and propose viable detection conditions based on resonance Raman (RR).
...
\nomenclature{ARfD}{Acute reference dose}
\nomenclature{BSSE}{Basis set superposition error}
\nomenclature{DFT}{Density functional theory}
\nomenclature{EF}{Enhancement factor}
\nomenclature{GEDISS}{Energy-represented direct inversion in the iterative subspace algorithm (EDISS) applied to geometry optimization}
...
\input{chapters/sunflowers.tex}
\input{chapters/stx.tex}
...
\includepdf[pages=-]{../images/back-cover-back.pdf}
\includepdf[pages=-]{../images/back-cover.pdf}
