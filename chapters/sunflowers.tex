...
It's NICS projection, plotted in \reffig{as08-2d}, shows positive values all through the inside of all of the rings, with negative values on the outside of the whole structure.
...
\fix{Add a small interpretation for each of the groups of flowers that share similar vibrations, and add all of their spectra to the corresponding section in the appendix.}
\blindtext[5]
