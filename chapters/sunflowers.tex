...
By designing, generating and studying our own family of sunflowers, we will be contributing to characterize a novel and interesting group of molecules, and we may be able to identify an ideal SERS and resonance Raman environment for STX.
...
This preference for Raman isn't arbitrary: \fix{Reasons: Raman can be used on water-based samples (such as seawater), and it's the base technique of the amplification methods that we want to study.}
...
Keeping in mind the final objectives of the work of applying resonance Raman, the electronic spectroscopic behavior of the flowers was deemed as an important point to study.
The characterization of the electronic transitions of a molecule might give plenty of insight on how does it interact with light.
...
It's displayed in \reffig{uv-s08}.
