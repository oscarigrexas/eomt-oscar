...
This idea is explored and applied in \refsec{heatmaps}.
...
This technique relies in the usage of a carefully selected laser wavelength: if it's close enough to an electronic transition, the scattering effect, and therefore the intensity of the measured raman peaks, can increase by several orders of magnitude.
