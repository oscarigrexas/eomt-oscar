...
\begin{figure*}
    ...
    \caption[Zoomed in Raman spectrum of lone STX]{Zoomed in Raman spectrum of lone STX}
...
The first study that must be carried out, before any spectroscopic technique can be applied, is that of adsorption: how does STX adhere to the flowers, how stable is the resulting complex, \fix{what is the nature of the interactions}...
...
The RR calculations from this step amounted to a total of 2858, where the amplification, position and relevance of each vibrational mode\sidenote{Between \num{186} and \num{222} depending on the size of the flower} had to be evaluated.
...
The UV-vis spectrum of As12-STX and some of its most relevant transitions have been included in \reffig{uv-as12} and \reftab{as12-transitions}.
